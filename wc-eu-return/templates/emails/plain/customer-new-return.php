...
echo esc_html__( 'Twój wniosek o odstąpienie od umowy został przyjęty.', 'wc-eu-return' ) . "\n\n";
...
echo esc_html__( 'O każdej zmianie statusu wniosku poinformujemy Cię mailowo.', 'wc-eu-return' ) . "\n";
